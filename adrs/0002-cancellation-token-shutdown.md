# ADR-0002: CancellationToken as the Single Shutdown Signal on AppState

**Date**: 2026-05-25
**Status**: Accepted
**Issue**: liminis-graph#78

## Context

The graceful shutdown sequence installed by liminis-graph#71 (PR #72) set
