# ADR-0053: Ontology `parent_edges:` segment conditionally included in content hash
...
entity types. The ontology content hash (ADR-0004) must cover parent relationships so that
