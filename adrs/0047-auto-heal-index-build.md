# ADR-0047: Auto-Heal Index Build and Bulk-Load Reload Pattern
...
liminis-graph uses lbug (Kuzu) as its graph database. lbug requires separate DDL calls to create
...
- ADR-0009: bound-parameter DB access (supersedes the escaping layer, same era as #143 refactor
