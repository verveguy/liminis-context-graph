...
- Provenance: this decision corresponds to the Liminis app's ADR-042 (concurrent read/write architecture), re-documented here for the extracted engine. (Python asyncio.Lock model; superseded by this lbug-specific Rust design)
