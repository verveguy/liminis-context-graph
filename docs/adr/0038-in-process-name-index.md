...
**Narrowed by ADR-0053** (#283): this rejection held uniformly across all four call sites, but
...
actually written to fix. ADR-0053 adds a bounded, self-healing scan fallback scoped only to the
