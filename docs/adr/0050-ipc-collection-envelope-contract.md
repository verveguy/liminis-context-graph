# ADR-0050: IPC Collection Response Envelope Contract

**Status:** Accepted  
**Date:** 2026-05-26  
**Relates to:** issue #96 (entity-search UI bug), ADR-0042 (reader-writer split), ADR-0044 (embedder HTTP contract)

## Context

liminis-graph's IPC protocol returns collection data from many methods. Prior to this ADR,
...
**Conformance enforcement.** `liminis-graph-core/tests/ipc_response_shapes.rs` calls every
