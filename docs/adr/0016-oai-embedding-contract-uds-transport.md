# ADR-0016: OpenAI-compatible embedding contract over UDS; hyper for UDS transport

**Date**: 2026-05-25
**Status**: Accepted
**Supersedes**: ADR-0006 (wire-format section only)

## Context

The `liminis-context-graph` binary previously spoke a bespoke
...
This supersedes ADR-0006's wire-format section. The old `{"text": ..., "model": ...}` /
