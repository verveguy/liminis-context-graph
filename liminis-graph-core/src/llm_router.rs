...
impl LlmRouter {
    ...
    async fn do_extract<'a>(&'a self, opts: ExtractOptions<'a>) -> Result<ExtractionResult, Error> {
        ...
        // ExtractOptions is Copy, so it can be passed to both primary and fallback.
